                ...
                <div className="grid grid-cols-2 gap-2">
                  {[
                    ...
                    <button
                      ...
                      className={`px-4 py-3 rounded-2xl border text-[10px] font-black uppercase tracking-widest transition-all ${showId === mode.sid && showQr === mode.sqr
                            ...
                            <div className="grid grid-cols-4 gap-1.5">
                              {FONT_OPTIONS.map(f => (
                                <button
                                  ...
                                  className={`py-2.5 rounded-xl border text-[10px] font-bold transition-all active:scale-95 ${(selField.fontFamily || 'sans-serif') === f.value
                            ...
                            <div className="grid grid-cols-4 gap-1.5">
                              {[
                                ...
                                <button
                                  ...
                                  onClick={btn.action}
                                  title={btn.label}
                                  className={`py-2.5 rounded-xl border flex items-center justify-center transition-all active:scale-95 ${btn.active
                                      ? 'border-indigo-500 bg-indigo-500/15 text-indigo-300'
                                      : 'border-white/5 bg-black/30 text-[var(--text-secondary)] hover:border-white/20 hover:text-[var(--text-primary)]'
                                    }`}
                                >
                            ...
                            <div className="grid grid-cols-3 gap-1.5">
                              {[
                                ...
                                <button
                                  ...
                                  className={`py-2.5 rounded-xl border flex items-center justify-center transition-all active:scale-95 ${(selField.textAlign || 'left') === a.value
                                      ? 'border-indigo-500 bg-indigo-500/15 text-indigo-300'
                                      : 'border-white/5 bg-black/30 text-[var(--text-secondary)] hover:border-white/20 hover:text-[var(--text-primary)]'
                                    }`}
                                >
                            ...
                            <div className="grid grid-cols-8 gap-1.5">
                              {PRESET_COLORS.map(hex => (
                                <button
                                  ...
                                  title={hex}
                                  className={`w-full aspect-square rounded-lg border-2 transition-all active:scale-90 ${rgbToHex(selField.color) === hex
                    ...
                    <div className="space-y-4">
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div className="space-y-2 text-left">
                          ...
                          <input
                            type="text"
                            className="w-full bg-white/5 border border-white/5 rounded-2xl py-4 px-6 text-sm text-[var(--text-primary)] focus:outline-none focus:border-indigo-500 transition-all font-medium placeholder:text-[var(--text-secondary)]"
                      ...
                      <div className="space-y-2 text-left">
                        ...
                        <textarea
                          className="w-full bg-white/5 border border-white/5 rounded-2xl py-4 px-6 text-sm text-[var(--text-primary)] h-32 resize-none focus:outline-none focus:border-indigo-500 transition-all font-medium placeholder:text-[var(--text-secondary)]"
