...
import { Search, CheckCircle, XCircle, Camera, X, Upload, Loader2, MessageSquare, Send } from 'lucide-react';
        ...
        <div className="glass rounded-2xl sm:rounded-[3.5rem] p-4 sm:p-12 shadow-2xl border border-[var(--border-subtle)] relative overflow-hidden group">
          ...
          {!isScanning ? (
            <div className="space-y-10">
              ...
              {!result && (
                <div className="mb-4 flex flex-col items-center justify-center space-y-2 group/msg animate-fade-in">
                  <div className="flex items-center space-x-2 text-[10px] font-black uppercase tracking-[0.2em] text-red-500/60 group-hover/msg:text-red-500 transition-colors">
                    <span className="relative flex h-2 w-2">
                      <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-red-400 opacity-75"></span>
                      <span className="relative inline-flex rounded-full h-2 w-2 bg-red-500"></span>
                    </span>
                    <span>Heartbeat signal sent</span>
                  </div>
                  <p className="text-[11px] font-bold text-red-500 tracking-wide flex items-center space-x-1">
                    <span>Have a Great Day</span>
                    <span className="animate-bounce">✨</span>
                    <span>Please be patient to load</span>
