      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex flex-wrap items-center gap-3 self-start sm:self-auto">
          ...
          <button
            ...
            className="inline-flex items-center justify-center gap-2 px-4 py-2.5 bg-indigo-600/10 border border-indigo-500/30 hover:bg-indigo-600 hover:text-white text-indigo-400 font-semibold text-xs rounded-xl transition-all shadow-sm active:scale-95 cursor-pointer self-end"
          >
