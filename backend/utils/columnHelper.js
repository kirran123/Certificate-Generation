/**
 * columnHelper.js - Shared Backend Utility for Smart Column Matching & Value Extraction
...
const isFeedbackQuestionHeader = (header) => {
...
const findBestColumnForField = (headers = [], fieldType = '') => {
...
const findBestNameColumn = (headers = []) => findBestColumnForField(headers, 'name');
const findBestEmailColumn = (headers = []) => findBestColumnForField(headers, 'email');
const findBestCollegeColumn = (headers = []) => findBestColumnForField(headers, 'college');
const findBestDeptColumn = (headers = []) => findBestColumnForField(headers, 'department');
const findBestYearColumn = (headers = []) => findBestColumnForField(headers, 'year');
 ...
 */
const getRowColumnValue = (row = {}, targetCol = '', fieldType = '') => {
...
module.exports = {
  cleanHeaderName,
  isFeedbackQuestionHeader,
  findBestColumnForField,
  findBestNameColumn,
  findBestEmailColumn,
  findBestCollegeColumn,
  findBestDeptColumn,
  findBestYearColumn,
  getRowColumnValue
};
